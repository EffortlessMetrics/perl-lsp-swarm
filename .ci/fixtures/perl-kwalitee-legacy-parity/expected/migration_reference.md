...
| `quality.no_new_severe_gaps` | no new severe coverage/ripr regressions | yes | 15 | `quality_gate_receipt` | `all` | `engineering_evidence` / `engineering_evidence.no_new_severe_gaps` | `transfer` | #4791 | `cargo xtask quality-gate --mode enforce-new-ripr --ripr-receipt target/receipts/quality/ripr-plus.json --ripr-pr-receipt target/ripr/pr/repo-exposure.json --review-receipt target/ripr/review/comments.json` |
