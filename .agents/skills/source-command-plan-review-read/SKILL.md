---
name: "source-command-plan-review-read"
description: "Plan reviewer step 1 — read the issue and understand the scout's analysis"
---

# source-command-plan-review-read

Use this skill when the user asks to run the migrated source command `plan-review-read`.
