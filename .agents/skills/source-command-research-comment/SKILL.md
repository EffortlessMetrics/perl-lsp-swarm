---
name: "source-command-research-comment"
description: "Research verifier step 5 — post verification findings as a structured issue comment and add label"
---

# source-command-research-comment

Use this skill when the user asks to run the migrated source command `research-comment`.
