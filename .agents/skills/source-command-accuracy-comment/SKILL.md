---
name: "source-command-accuracy-comment"
description: "Accuracy-scout step 5 — draft accuracy comment, update issue, add label"
---

# source-command-accuracy-comment

Use this skill when the user asks to run the migrated source command `accuracy-comment`.
