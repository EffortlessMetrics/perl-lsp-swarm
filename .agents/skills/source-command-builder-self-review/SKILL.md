---
name: "source-command-builder-self-review"
description: "Builder step 5 — re-read your own diff before publishing"
---

# source-command-builder-self-review

Use this skill when the user asks to run the migrated source command `builder-self-review`.
