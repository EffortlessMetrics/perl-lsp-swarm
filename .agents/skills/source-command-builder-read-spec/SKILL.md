---
name: "source-command-builder-read-spec"
description: "Builder step 1 — read the spec, then build"
---

# source-command-builder-read-spec

Use this skill when the user asks to run the migrated source command `builder-read-spec`.
