---
name: "source-command-spec-planner-comment"
description: "Spec planner step 5 — post the checklist as an issue comment with branch name"
---

# source-command-spec-planner-comment

Use this skill when the user asks to run the migrated source command `spec-planner-comment`.
