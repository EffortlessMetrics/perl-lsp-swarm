---
name: "source-command-spec-planner-plan"
description: "Spec planner step 3 — produce the ordered implementation checklist and rich acceptance.md"
---

# source-command-spec-planner-plan

Use this skill when the user asks to run the migrated source command `spec-planner-plan`.
