---
name: "source-command-reviewer-deep-analyze"
description: "Deep reviewer step 2 — analyze if the diff logic is correct"
---

# source-command-reviewer-deep-analyze

Use this skill when the user asks to run the migrated source command `reviewer-deep-analyze`.
