---
name: "source-command-plan-review-improve"
description: "Plan reviewer step 4 — improve the spec and mark builder-ready"
---

# source-command-plan-review-improve

Use this skill when the user asks to run the migrated source command `plan-review-improve`.
