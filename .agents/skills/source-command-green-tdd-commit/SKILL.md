---
name: "source-command-green-tdd-commit"
description: "Green TDD hardener step 4 — commit, push, comment on issue"
---

# source-command-green-tdd-commit

Use this skill when the user asks to run the migrated source command `green-tdd-commit`.
