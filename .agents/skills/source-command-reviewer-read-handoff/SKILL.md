---
name: "source-command-reviewer-read-handoff"
description: "Reviewer step 1 — read the PR handoff, check knowledge artifact quality"
---

# source-command-reviewer-read-handoff

Use this skill when the user asks to run the migrated source command `reviewer-read-handoff`.
