---
name: "source-command-check-agent-audit-trail"
...
# source-command-check-agent-audit-trail

Use this skill when the user asks to run the migrated source command `check-agent-audit-trail`.
