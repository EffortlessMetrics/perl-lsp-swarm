---
name: "source-command-reviewer-deep-read-spec"
description: "Deep reviewer step 1 — read the original issue spec to understand intent"
---

# source-command-reviewer-deep-read-spec

Use this skill when the user asks to run the migrated source command `reviewer-deep-read-spec`.
