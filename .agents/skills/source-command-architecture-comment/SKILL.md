---
name: "source-command-architecture-comment"
description: "Architecture reviewer step 3 — post alignment findings as issue comment"
---

# source-command-architecture-comment

Use this skill when the user asks to run the migrated source command `architecture-comment`.
