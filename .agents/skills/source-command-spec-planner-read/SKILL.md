---
name: "source-command-spec-planner-read"
description: "Spec planner step 1 — read the issue, plan-review, and verification comments"
---

# source-command-spec-planner-read

Use this skill when the user asks to run the migrated source command `spec-planner-read`.
