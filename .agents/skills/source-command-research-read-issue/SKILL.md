---
name: "source-command-research-read-issue"
description: "Research verifier step 1 — read the scout issue and extract all factual claims for verification"
---

# source-command-research-read-issue

Use this skill when the user asks to run the migrated source command `research-read-issue`.
