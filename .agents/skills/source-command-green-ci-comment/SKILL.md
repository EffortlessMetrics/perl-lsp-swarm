---
name: "source-command-green-ci-comment"
description: "Green CI agent step 2 — post verdict as PR comment and set label"
---

# source-command-green-ci-comment

Use this skill when the user asks to run the migrated source command `green-ci-comment`.
