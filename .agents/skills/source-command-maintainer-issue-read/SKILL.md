---
name: "source-command-maintainer-issue-read"
description: "Maintainer vision (issue) step 1 — read the issue, roadmap, and current priorities"
---

# source-command-maintainer-issue-read

Use this skill when the user asks to run the migrated source command `maintainer-issue-read`.
