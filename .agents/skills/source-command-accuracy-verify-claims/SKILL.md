---
name: "source-command-accuracy-verify-claims"
description: "Accuracy-scout step 3 — run minimal examples to reproduce issue claims (if applicable)"
---

# source-command-accuracy-verify-claims

Use this skill when the user asks to run the migrated source command `accuracy-verify-claims`.
