...
The root retains review scope and current/stale dimensions, evidence credibility and
contradictions, finding severity/disposition, whether the claim is supported or requires
repair/`NOT_PROVEN`/prerequisite/closeout, and the one cumulative submitted review plus
next route.
