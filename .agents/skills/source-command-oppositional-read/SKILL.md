---
name: "source-command-oppositional-read"
description: "Oppositional planner step 1 — read the issue and understand the proposed approach"
---

# source-command-oppositional-read

Use this skill when the user asks to run the migrated source command `oppositional-read`.
