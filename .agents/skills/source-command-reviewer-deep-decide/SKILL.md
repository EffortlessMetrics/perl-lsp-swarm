---
name: "source-command-reviewer-deep-decide"
description: "Deep reviewer step 4 — approve or send back with analysis"
---

# source-command-reviewer-deep-decide

Use this skill when the user asks to run the migrated source command `reviewer-deep-decide`.
