---
name: "source-command-swarm-priorities"
description: "Load roadmap priorities and weight scout targets for strategic alignment"
---

# source-command-swarm-priorities

Use this skill when the user asks to run the migrated source command `swarm-priorities`.
