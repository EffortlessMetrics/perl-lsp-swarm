---
name: "source-command-accuracy-verify-status"
description: "Accuracy-scout step 4 — check if issue already fixed via recent merges or commits"
---

# source-command-accuracy-verify-status

Use this skill when the user asks to run the migrated source command `accuracy-verify-status`.
