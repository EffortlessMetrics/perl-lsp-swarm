---
name: "source-command-oppositional-comment"
description: "Oppositional planner step 3 — post challenges as a structured issue comment"
---

# source-command-oppositional-comment

Use this skill when the user asks to run the migrated source command `oppositional-comment`.
