---
name: "source-command-plan-review-stress"
description: "Plan reviewer step 3 — stress-test the proposed approach"
---

# source-command-plan-review-stress

Use this skill when the user asks to run the migrated source command `plan-review-stress`.
