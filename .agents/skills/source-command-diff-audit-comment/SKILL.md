---
name: "source-command-diff-audit-comment"
description: "Diff auditor step 2 — post findings and set label"
---

# source-command-diff-audit-comment

Use this skill when the user asks to run the migrated source command `diff-audit-comment`.
