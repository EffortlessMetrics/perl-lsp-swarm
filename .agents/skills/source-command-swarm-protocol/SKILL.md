---
name: "source-command-swarm-protocol"
description: "Load swarm behavioral rules — autonomy, messaging, metrics, learning, GitHub-native tracking"
---

# source-command-swarm-protocol

Use this skill when the user asks to run the migrated source command `swarm-protocol`.
...
| **Memory** | Across sessions | Codex memories | Critical lessons future sessions need |

### When to write Codex memories
...
3. **Lead** → Codex memories for cross-session knowledge
