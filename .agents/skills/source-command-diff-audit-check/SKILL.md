---
name: "source-command-diff-audit-check"
description: "Diff auditor step 1 — review the complete PR diff for coherence and cleanliness"
---

# source-command-diff-audit-check

Use this skill when the user asks to run the migrated source command `diff-audit-check`.
