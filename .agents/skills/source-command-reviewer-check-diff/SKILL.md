---
name: "source-command-reviewer-check-diff"
description: "Reviewer step 2 — check the diff for correctness, standards, and scope"
---

# source-command-reviewer-check-diff

Use this skill when the user asks to run the migrated source command `reviewer-check-diff`.
