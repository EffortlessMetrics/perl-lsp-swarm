...
const XTASK_PROOF: &str = "cargo test --locked -p xtask --lib receipt_output::tests::dangling_protected_source_rejects_before_publication_write -- --exact --nocapture";
...
const XTASK_PROOF_ANCHOR: &str = "          $output = cargo test --locked -p xtask --lib receipt_output::tests::dangling_protected_source_rejects_before_publication_write -- --exact --nocapture 2>&1\n";
