...
use tasks::{
    ...
    compare, compat_inventory, compiler_lexical_cutline, compiler_performance_receipt,
    corpus_audit, count_ratchet, cpan_corpus, critic_rule_proof, dead_code, debt_report,
