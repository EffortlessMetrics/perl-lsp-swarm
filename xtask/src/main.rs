...
enum VimEditorCompatCommand {
    ...
    Run {
        ...
        /// freshness-generations, or host-reopen-lifecycle.
        #[arg(long, default_value = "host-lifecycle")]
        journey: String,

        /// Fixture variant for the bootstrap-diagnostics,
        /// freshness-generations, and host-reopen-lifecycle journeys (canonical
        /// must pass; the negative controls must fail with their typed reason).
                    ...
                    if journey != "host-lifecycle" {
                        return Err(eyre!(
                            "unknown journey {journey}: known journeys are host-lifecycle, \
                             bootstrap-diagnostics, freshness-generations, host-reopen-lifecycle"
                        ));
                    }
