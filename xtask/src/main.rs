...
enum VimEditorCompatCommand {
    ...
    Run {
        ...
        /// freshness-generations, or recovery-generations.
        #[arg(long, default_value = "host-lifecycle")]
        journey: String,

        /// Fixture variant for the bootstrap-diagnostics,
        /// freshness-generations, and recovery-generations journeys (canonical
        /// must pass; the negative controls must fail with their typed
        /// reason).
