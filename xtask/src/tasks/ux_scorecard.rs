...
mod tests {
    ...
    /// Production baseline loading goes through `ratchet::load_baseline`;
    /// this path is the fixture location the regression suite below writes
    /// its baseline stubs to.
