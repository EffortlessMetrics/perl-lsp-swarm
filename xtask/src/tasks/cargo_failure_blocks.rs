...
";
    ...
    #[test]
    fn each_block_stops_at_the_next_header() {
    ...
    #[test]
    fn the_last_block_stops_before_the_run_trailer() {
        let blocks = failure_blocks(TWO_FAILURES);
    ...
    #[test]
    fn a_panic_location_is_read_from_its_own_block() {
        let blocks = failure_blocks(TWO_FAILURES);
    ...
    #[test]
    fn a_block_without_a_panic_reports_no_location() {
    ...
    #[test]
    fn failed_lines_name_every_failing_test_once() {
        assert_eq!(
    ...
    #[test]
    fn a_log_with_no_failures_yields_nothing() {
    ...
    #[test]
    fn the_legacy_quoted_panic_format_still_yields_a_location() {
    ...
    #[test]
    fn a_repeated_block_header_keeps_the_first_occurrence() {
        let raw = "---- t stdout ----\nfirst\n---- t stdout ----\nsecond\n";
