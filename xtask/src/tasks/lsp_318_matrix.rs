...
const ROWS: &[MatrixRow] = &[
    ...
    MatrixRow {
        ...
        priority: "P3",
        notes: "Representative markdown/string outputs are absence-tested for `command:` links and `$()` theme-icon syntax; do not introduce richer markdown affordances without capability parsing.",
    },
    MatrixRow {
