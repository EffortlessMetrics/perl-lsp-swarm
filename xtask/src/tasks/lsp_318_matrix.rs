...
const ROWS: &[MatrixRow] = &[
    ...
    MatrixRow {
        ...
        owner: "server-originated apply-edit helpers",
        priority: "P2",
        notes: "Upstream 3.18 metadata is on applyEdit params, not `WorkspaceEdit` responses; no server-originated applyEdit metadata path is currently claimed.",
    },
    MatrixRow {
