...
const ROWS: &[MatrixRow] = &[
    ...
    MatrixRow {
        ...
        method_or_shape: "`textDocument/codeLens`; `codeLens/resolve`; `textDocument/codeAction`",
        status: "implemented+tested+documented",
        proof: "`lsp_codelens_tests`; `lsp_command_tooltip_tests`; `lsp_318_negative_claims`; `check-lsp-318-claims`",
        owner: "`crates/perl-lsp-rs-core/src/protocol/command.rs`; CodeLens handlers; `crates/perl-lsp-rs/src/runtime/language/code_actions.rs`",
        priority: "P3",
        notes: "Plain-text tooltips are required on every reachable LSP Command object. CodeLens receipts are unchanged. Completion, inline-completion, and document-link surfaces do not produce Command objects.",
    },
    MatrixRow {
