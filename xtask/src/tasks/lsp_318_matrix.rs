...
const ROWS: &[MatrixRow] = &[
    ...
    MatrixRow {
        ...
        status: "implemented-needs-positive-wire-test",
        proof: "`lsp_318_negative_claims`; `lsp_refresh_methods_tests`; `check-lsp-318-claims`",
        owner: "`crates/perl-lsp-rs/src/runtime/client_requests.rs`; `crates/perl-lsp-rs/src/runtime/refresh.rs`",
        priority: "P1",
        notes: "Unsupported clients are guarded; add a positive refresh-support wire receipt before marking locked.",
    },
    MatrixRow {
