...
///
/// Production aggregation flows through `run_with_receipt_dir`; this guarded
/// direct wrapper has no production caller and is retained for the
/// receipt-identity regression suite below, which pins fail-closed behavior
