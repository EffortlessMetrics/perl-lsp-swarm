...
#[path = "release_artifact_size/measure.rs"]
mod measure;
#[path = "release_artifact_size/model.rs"]
mod model;
#[path = "release_artifact_size/render.rs"]
mod render;
...
pub(crate) const CLAIM_BOUNDARY: &str = "same-SHA post-strip size and packaged-binary smoke comparison for perllsp and perl-dap on one native macOS target; does not prove startup/RSS improvement, other targets, publication, or general release readiness";
