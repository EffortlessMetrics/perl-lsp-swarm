...
- result: 0 errors, 284 warnings
- breakdown by rule: 275 `typescript/no-explicit-any`, 9 `no-unused-vars`, 0
  `typescript/consistent-type-imports`
- breakdown by surface: 284 tests, 0 scripts, 0 production, 0 build-config
