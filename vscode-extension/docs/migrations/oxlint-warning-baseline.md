...
- result: 0 errors, 141 warnings
- breakdown by rule: 138 `typescript/no-explicit-any`, 3 `no-unused-vars`, 0
  `typescript/consistent-type-imports`
- breakdown by surface: 141 tests, 0 scripts, 0 production, 0 build-config
