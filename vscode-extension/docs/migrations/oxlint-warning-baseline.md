...
- result: 0 errors, 429 warnings
- breakdown by rule: 397 `typescript/no-explicit-any`, 18 `no-console`, 11
  `no-unused-vars`, 3 `typescript/consistent-type-imports`
- breakdown by surface: 411 tests, 18 scripts, 0 production, 0 build-config
