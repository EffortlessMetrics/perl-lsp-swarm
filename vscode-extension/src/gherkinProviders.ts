...
// patterns (see #859). The inner `[+*{]` catches both unbounded (`+`/`*`) and
// bounded (`{m,n}`) inner quantifiers (see #953). Keep this in sync with the
// identical constant in gherkinStepDefinitions.ts.
