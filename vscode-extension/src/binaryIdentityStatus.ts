  ...
  switch (response.compatibility) {
    ...
    case 'compatible_partial':
      return {
        ...
        detail:
          'The server is usable, but source, target, candidate, or DAP identity is not fully proven.',
        supportPacket: copied,
      };
    ...
    case 'stale':
      return {
        ...
        detail:
          'The server process or workspace snapshot changed. Refresh identity before drawing a compatibility conclusion.',
        supportPacket: copied,
      };
    ...
    case 'not_proven':
      return {
        ...
        detail:
          'Identity evidence was unavailable or contradictory. This is not a product-failure verdict.',
        supportPacket: copied,
      };
    ...
    case 'mismatch': {
      ...
      if (selectedRole === 'managed') {
        ...
        return {
          ...
          detail:
            'The selected server, DAP, target, source, or candidate does not match the extension expectation.',
          supportPacket: copied,
      ...
      return {
        ...
        detail:
          'Review the configured user-supplied binary. It will not be replaced automatically.',
        supportPacket: copied,
        noticeKey: noticeKey(response, state),
      };
    }
