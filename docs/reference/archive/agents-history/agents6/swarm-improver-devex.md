...
Invoke `/swarm-protocol`. Check `.ops-perl-lsp/completed-slices.md` before starting any improvement. Read `.ops-perl-lsp/discovered-issues.md` — builders and fixers flag devex friction directly to you.
