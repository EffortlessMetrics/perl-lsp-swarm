...
Invoke `/swarm-protocol`. Check `.ops-perl-lsp/completed-slices.md` before starting any improvement. Read `.ops-perl-lsp/discovered-issues.md` for infra issues flagged by other agents.
