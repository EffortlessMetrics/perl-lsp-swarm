...
3. **Multi-threading**: the `threads` request answers with one synthetic main execution context for DAP conformance only; Coro discovery and Perl interpreter-thread discovery are not proven
