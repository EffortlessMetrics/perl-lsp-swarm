...
### UTF-16 Position Security Enhancement (*Diataxis: Explanation* - Security-first position mapping)

**Critical Security Update**: The position conversion layer maps UTF-16 code-unit columns to UTF-8 byte offsets while validating character boundaries and preserving symmetric position handling. This is important for LSP implementations processing Unicode-rich Perl code.
...
## Secure UTF-16 Position Mapping (*Diataxis: Reference* - Position conversion API and security patterns)
...
3. **Position Mapping** (Future Phase 2): UTF-16/UTF-8 conversion for breakpoints
   - Reuse secure position conversion infrastructure
