...
| [docs/forensics/2026-06-26-ai-orchestrated-work-shape.md](../forensics/2026-06-26-ai-orchestrated-work-shape.md) | What a normal retro misses: the new scarce resources (honest signal, forcing function, second instrument, producer-verifier protocol), why production is free but gates are not, and the structural vs. cultural integrity distinction at AI scale |
