...
first-party fact authority, and a source-spelled explicit import must not be
treated as proof that an unknown module exports the requested name. #13527 owns
the exact pinned first-party module/import/generated-helper contract; #13347
owns fail-closed admission; #13225 and #13226 own the independent runtime oracle
and durable falsification corpus; and #13544 owns the separate direct
`Test2::Tools::Target` compatibility leaf.
