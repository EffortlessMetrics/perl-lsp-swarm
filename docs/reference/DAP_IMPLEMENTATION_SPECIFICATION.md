...
pub fn dap_breakpoint_to_byte_offset(
    ...
    // Reuse LSP infrastructure (PR #753 symmetric conversion)
...
pub fn render_variable_value(value: &str, rope: &Rope) -> String {
    ...
    if value.len() > 1024 {
        ...
        // UTF-16 safe truncation (reuse PR #753 infrastructure)
...
- Unicode boundary safety (PR #753 symmetric conversion)
...
**Requirement**: Reuse PR #753 symmetric position conversion for variable rendering
...
pub fn render_variable_value(value: &str, rope: &Rope) -> String {
    if value.len() > 1024 {
        ...
        // UTF-16 safe truncation (PR #753 infrastructure)
        let safe_truncate = ensure_utf16_boundary(truncated, rope);
        format!("{}…", safe_truncate)
    } else {
        value.to_string()
