...
| Active goal manifest touched | `cargo xtask check-active-goal-manifest` | Verifies the swarm active manifest, lane caps, linked docs, work items, and proof command shape. |
...
| Active goal manifest touched | `rtk cargo xtask check-active-goal-manifest` | Verifies `.perl-lsp/goals/active.toml` points at existing specs, ADRs, status docs, receipts, and anchors. |
