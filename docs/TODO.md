...
- [ ] Expand `docs/how-to/UPGRADING.md` with compatibility promises, patch/minor expectations, deprecation notice windows, emergency-break guidance, and rollback/stale-state guidance.
...
- [ ] Capture dependency ordering in `docs/project/CI_LOCAL_VALIDATION.md`.
- [ ] Assign owners for each validation stage in `docs/project/CI_LOCAL_VALIDATION.md`.
