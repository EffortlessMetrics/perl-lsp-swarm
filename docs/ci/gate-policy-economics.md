...
which is the authority for these counts. Last refreshed 2026-09-07 (#13281):

- 85 gates in `.ci/gate-policy.yaml`
- 25 lanes in `policy/ci-lanes.toml`
- 85 / 85 gates have at least one lane mapping
