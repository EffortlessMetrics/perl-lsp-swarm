...
which is the authority for these counts. Last refreshed 2026-09-18 (short-circuit focused gates #14409 on #15569):

- 90 gates in `.ci/gate-policy.yaml`
- 25 lanes in `policy/ci-lanes.toml`
- 90 / 90 gates have at least one lane mapping
