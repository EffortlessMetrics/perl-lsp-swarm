...
| Rails framework adoption | [`development/RAILS_FRAMEWORK_ADOPTION_ROLLOUT.md`](../development/RAILS_FRAMEWORK_ADOPTION_ROLLOUT.md) | #0000 | orchestrator | 5 | Phase 1: framework footprint decision + `.rails/` ownership boundary |
