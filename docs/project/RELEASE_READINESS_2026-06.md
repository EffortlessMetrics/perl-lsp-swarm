...
**Status**: historical, superseded by the v0.18 release-train authority. The dispatch hold and CPAN caveat below remain historical decisions; do not tag, publish, or dispatch a release without Steven's explicit approval.
