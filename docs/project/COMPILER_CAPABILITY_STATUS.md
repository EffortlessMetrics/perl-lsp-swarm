...
| Tooling IR / PIR | `fixture-backed` | [#8196](https://github.com/EffortlessMetrics/perl-lsp/issues/8196) | [Compiler facts](status/compiler_facts.md), `crates/perl-parser-core/src/pir/`, `crates/perl-parser-core/tests/pir_tests.rs` | PIR v0 data model and HIR lowering are fixture-backed; broaden context propagation and add branch/loop/return control-flow lowering, no provider cutover |
