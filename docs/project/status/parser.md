...
| **Project corpus** | 100.0% clean (`206/206`) | Deterministic regression baseline; `184` `test_corpus/` + `22` `perl-corpus` files, `0` errors, `0` timeouts, `0` panics, `74/77` NodeKinds, `12/12` GA features | `test_corpus/` + `crates/perl-corpus/src/gen` |
