...
| **Project corpus** | 100.0% clean (`203/203`) | Deterministic regression baseline; `181` `test_corpus/` + `22` `perl-corpus` files, `0` errors, `0` timeouts, `0` panics, `73/76` NodeKinds, `12/12` GA features | `test_corpus/` + `crates/perl-corpus/src/gen` |
