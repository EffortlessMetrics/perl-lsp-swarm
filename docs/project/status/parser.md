...
| **Accuracy denominator** | 52 fixtures / 30 families | 147 scored lines, 130 scored symbols, 6 fully labeled, 45 partial, 33 unknown, 6 negative, 13 dynamic boundaries, 9 unsupported, 0 real-project, 0 generated, 52 hand-labeled; cadence `pr` | `target/metrics/parser_accuracy.json`; `.kiro/specs/parser-accuracy-observability` |
