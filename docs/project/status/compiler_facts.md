...
| Prototype table | `fixture-backed` | [#8197](https://github.com/EffortlessMetrics/perl-lsp/issues/8197) | `crates/perl-parser-core/tests/hir_tests.rs` | Capture prototype text/classification and shadow diagnostics before any provider use |
