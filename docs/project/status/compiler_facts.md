...
| Bareword classifier | `fixture-backed` | [#8197](https://github.com/EffortlessMetrics/perl-lsp/issues/8197) | `crates/perl-parser-core/tests/hir_tests.rs` | Keep constant/subroutine/package/filehandle/string-like/dynamic/unknown classification substrate available; no provider, diagnostic, parser-bucket, PIR, or support-tier promotion follows from this row |
