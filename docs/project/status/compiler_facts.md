...
| Differential real-Perl oracle | `contract-defined` | [#8199](https://github.com/EffortlessMetrics/perl-lsp/issues/8199), [#8294](https://github.com/EffortlessMetrics/perl-lsp/issues/8294) | [PLSP-SPEC-0027](../../specs/PLSP-SPEC-0027-differential-oracle-contract.md); selected compile-effect oracle proof in [#8300](https://github.com/EffortlessMetrics/perl-lsp/pull/8300) | Broader conformance receipts remain planned; real Perl stays a comparison oracle, not an editor-runtime dependency |
