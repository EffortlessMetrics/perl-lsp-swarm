...
receiver_fact_completion_cutover:
  ...
  fallback_proven: dynamic hash key, method/accessor receiver chains, and dynamic bless preserve fallback boundaries
