...
receiver_fact_completion_cutover:
  ...
  fallback_proven: dynamic hash key, method/accessor/local-accessor-chain/dynamic-local-accessor-chain/conditional-local-reassignment receiver chains, dynamic bless, and array-index receivers preserve fallback boundaries
