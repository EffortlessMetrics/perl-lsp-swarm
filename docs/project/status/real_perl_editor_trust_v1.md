...
project-shaped accessor-return, method-return, and local accessor-chain
method-return receiver chains as low-confidence fallback with tier-6 sorting.
It keeps medium-confidence facts from silently becoming exact source-backed
completion evidence.
