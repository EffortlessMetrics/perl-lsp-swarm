...
and dynamic local accessor-chain method-return receiver chains as low-confidence
fallback with tier-6 sorting. It keeps medium-confidence and dynamic facts from
