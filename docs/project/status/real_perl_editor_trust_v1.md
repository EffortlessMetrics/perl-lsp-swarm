...
project-shaped accessor-return and method-return receiver chains as
low-confidence fallback with tier-6 sorting. It keeps medium-confidence facts
from silently becoming exact source-backed completion evidence.
