...
parser/HIR `variable` token and `didChange` freshness is proven.
...
lexical-variable declaration, lexical-variable use, and our-variable declaration trace slices that emit no
new token output.
...
lexical-variable declaration, lexical-variable use, and our-variable declaration proofs stay scoped,
output-neutral, and
...
declaration, lexical-variable use, and our-variable declaration rows so the class
