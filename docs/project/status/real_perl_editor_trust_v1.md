...
| Differential oracle contract | [PLSP-SPEC-0027](../../specs/PLSP-SPEC-0027-differential-oracle-contract.md) |
...
The differential oracle contract is now defined as a planning boundary. It
allows future receipts to compare Rust-native facts, parser output, module
resolution, PIR lowering, or provider receipts against explicitly bounded real
Perl/perldoc/oracle observations. It does not add oracle execution, workspace
probing, provider behavior, parser bucket movement, support-tier promotion,
release-lineage sync, or a real-Perl editor-runtime dependency.
