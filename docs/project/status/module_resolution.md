...
| Provider/product support | independent | definition, completion, hover, diagnostics, symbols, refactors, installed VS Code, other clients/platforms | [#1744](https://github.com/EffortlessMetrics/perl-lsp-swarm/issues/1744) / [#4243](https://github.com/EffortlessMetrics/perl-lsp-swarm/issues/4243) and exact consumer owners |
