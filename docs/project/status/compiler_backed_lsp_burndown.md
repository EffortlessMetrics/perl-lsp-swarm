...
| P3 | Compile bucket burn-down | Yellow / ongoing | #3474 focused runner proof moves `base/lex.t` from `parse_recovery` to `compile_effect`; #3481 focused proof moves `base/term.t` from `compile_effect` to compile pass; #3483 focused proof moves `base/rs.t` from `compile_effect` to compile pass; #3485 focused proof moves `comp/require.t` from `parse_recovery` to `compile_effect`; #3487 focused proof moves `comp/use.t` from `parse_recovery` to `compile_effect`; #3490 focused proof moves `comp/proto.t` from `parse_recovery` to `compile_effect`; #3492 focused proof moves `comp/decl.t` from `parse_recovery` to compile pass; #3494 focused proof moves `comp/line_debug.t` from compile-mode `parse_recovery` to `compile_effect`; #3496 focused proof moves `base/lex.t` from `compile_effect` to compile pass; #3498 focused proof moves `comp/final_line_num.t` from compile-mode `parse_recovery` to `compile_effect`; #3500 focused proof moves `comp/parser.t` from compile-mode `parse_recovery` to `compile_effect`; #3502 focused proof moves `comp/our.t` from `compile_effect` to compile pass; #3506 focused proof moves `run/switch-I-and-M.t` and `run/switchM.t` from `compile_effect` to compile pass; #3508 focused proof moves `run/switch0.t`, `run/switchF2.t`, and `run/switcht.t` from `compile_effect` to compile pass; #3510 focused proof moves `run/switcha.t`, `run/switchF.t`, and `run/noswitch.t` from `compile_effect` to compile pass; #3512 focused proof moves `run/switchn.t` from `compile_effect` to compile pass; #3514 focused proof moves `run/switchp.t` from `compile_effect` to compile pass; #3516 focused proof moves `run/switchx.t` from `compile_effect` to compile pass; #3518 focused proof moves `run/switchI.t` from `compile_effect` to compile pass; #3520 focused proof moves `run/switchd-78586.t` from `compile_effect` to compile pass; #3522 focused proof moves `run/cloexec.t` from `compile_effect` to compile pass; #3524 focused proof moves `run/runenv_hashseed.t` from `compile_effect` to compile pass; #3526 focused proof moves `run/switchDx.t` from `compile_effect` to compile pass; #3528 focused proof moves `run/fresh_perl.t` from `compile_effect` to compile pass; #3530 focused proof moves `comp/line_debug.t` from `compile_effect` to compile pass; #3532 focused proof moves `comp/filter_exception.t` from `compile_effect` to compile pass; #3534 focused proof moves `comp/redef.t` from `compile_effect` to compile pass; #3536 focused proof moves `comp/multiline.t` from `compile_effect` to compile pass; current real upstream receipts still show `parse_recovery` in `run` and `compile_effect` in `comp` | Reduce one named bucket or tight cluster | One compile bucket shrinks without new `unknown` or unbucketed failures |
...
| `comp` parse/compile | compile-mode `parse_recovery` is cleared; `compile_effect` remains on eleven files including `comp/parser.t`, `comp/final_line_num.t`, `comp/require.t`, `comp/use.t`, and `comp/proto.t` | Reduce `comp/parser.t`, `comp/require.t`, `comp/hints.t`, or another tight comp compile-effect cluster |
