...
| H14 | First bucket burn-down | Green / advisory | #3428, #3429, #3474, #3481, #3483, #3485, #3487, #3490, #3492, #3494, #3496, #3498, #3500, #3502, #3506, #3508, #3510, #3512, #3514, #3516, #3518, #3520, #3522, #3524, #3526, #3528, #3530, #3532, #3534, #3536, #3538, #3540, #3543, #3545, #3548, #3551, #3553, #3555, #3557, [run 28730071077](https://github.com/EffortlessMetrics/perl-lsp-swarm/actions/runs/28730071077) | None | `base` `parse_recovery` reduced to 0 in the accepted compile ratchet; all nine upstream `base/*.t` files now compile cleanly; `comp/decl.t`, `comp/filter_exception.t`, `comp/fold.t`, `comp/final_line_num.t`, `comp/form_scope.t`, `comp/line_debug.t`, `comp/multiline.t`, `comp/our.t`, `comp/parser.t`, `comp/parser_run.t`, `comp/proto.t`, `comp/redef.t`, `comp/retainedlines.t`, `comp/use.t`, and `comp/utf.t` now compile cleanly; `comp/require.t` moved from compile-mode `parse_recovery` to `compile_effect`; `run/switch-I-and-M.t`, `run/switchM.t`, `run/switch0.t`, `run/switchF2.t`, `run/switcht.t`, `run/switcha.t`, `run/switchF.t`, `run/noswitch.t`, `run/switchn.t`, `run/switchp.t`, `run/switchx.t`, `run/switchI.t`, `run/switchd-78586.t`, `run/cloexec.t`, `run/runenv_hashseed.t`, `run/switchDx.t`, and `run/fresh_perl.t` now compile cleanly |
...
| `target/perl-core/smoke/comp/compile.json` | 23/25 passed, 0 `parse_recovery`, 2 `compile_effect` | Focused runner proofs for #3485, #3487, #3490, #3492, #3494, #3498, #3500, and #3502 move `comp/decl.t` and `comp/our.t` to compile pass and `comp/require.t`, `comp/use.t`, `comp/proto.t`, `comp/final_line_num.t`, and `comp/parser.t` to `compile_effect`; focused runner proofs for #3530, #3532, #3534, #3536, #3538, #3540, #3543, #3545, #3548, #3551, #3553, and #3555 move `comp/line_debug.t`, `comp/filter_exception.t`, `comp/redef.t`, `comp/multiline.t`, `comp/fold.t`, `comp/utf.t`, `comp/parser_run.t`, `comp/retainedlines.t`, `comp/proto.t`, `comp/use.t`, `comp/parser.t`, and `comp/final_line_num.t` to compile pass; focused #3557 proof moves `comp/form_scope.t` to compile pass; compile-effect failures include `comp/hints.t` and `comp/require.t` |
| `target/perl-core/smoke/comp/gap-map.json` | 41/50 mode-file entries passed; buckets: 7 `parse_recovery`, 2 `compile_effect` | Focused runner proofs for #3485, #3487, #3490, #3492, #3494, #3498, #3500, #3502, #3530, #3532, #3534, #3536, #3538, #3540, #3543, #3545, #3548, #3551, #3553, #3555, and #3557 update the accepted compile ratchet; parse-mode receipt from [run 28711942840](https://github.com/EffortlessMetrics/perl-lsp-swarm/actions/runs/28711942840) still contributes 7 `parse_recovery` entries |
...
| `.ci/perl-core-harness/upstream-comp-compile-baseline.json` | Ratchets 23/25 compile pass state; buckets: 2 `compile_effect` | Updated by focused #3485, #3487, #3490, #3492, #3494, #3498, #3500, and #3502 proofs for `comp/decl.t`, `comp/final_line_num.t`, `comp/parser.t`, `comp/require.t`, `comp/use.t`, `comp/proto.t`, and `comp/our.t`, plus focused #3530, #3532, #3534, #3536, #3538, #3540, #3543, #3545, #3548, #3551, #3553, #3555, and #3557 proofs for `comp/line_debug.t`, `comp/filter_exception.t`, `comp/redef.t`, `comp/multiline.t`, `comp/fold.t`, `comp/utf.t`, `comp/parser_run.t`, `comp/retainedlines.t`, `comp/proto.t`, `comp/use.t`, `comp/parser.t`, `comp/final_line_num.t`, and `comp/form_scope.t`; separate from generated fixture baseline |
