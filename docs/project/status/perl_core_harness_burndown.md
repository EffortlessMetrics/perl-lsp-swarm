...
| `target/perl-core/smoke/comp/compile.json` | 17/25 passed, 0 `parse_recovery`, 8 `compile_effect` | Focused runner proofs for #3485, #3487, #3490, #3492, #3494, #3498, #3500, and #3502 move `comp/decl.t` and `comp/our.t` to compile pass and `comp/require.t`, `comp/use.t`, `comp/proto.t`, `comp/final_line_num.t`, and `comp/parser.t` to `compile_effect`; focused runner proofs for #3530, #3532, #3534, #3536, #3538, #3540, and #3543 move `comp/line_debug.t`, `comp/filter_exception.t`, `comp/redef.t`, `comp/multiline.t`, `comp/fold.t`, `comp/utf.t`, and `comp/parser_run.t` to compile pass; compile-effect failures include `comp/final_line_num.t`, `comp/form_scope.t`, `comp/hints.t`, `comp/parser.t`, `comp/proto.t`, `comp/require.t`, `comp/retainedlines.t`, `comp/use.t` |
| `target/perl-core/smoke/comp/gap-map.json` | 35/50 mode-file entries passed; buckets: 7 `parse_recovery`, 8 `compile_effect` | Focused runner proofs for #3485, #3487, #3490, #3492, #3494, #3498, #3500, #3502, #3530, #3532, #3534, #3536, #3538, #3540, and #3543 update the accepted compile ratchet; parse-mode receipt from [run 28711942840](https://github.com/EffortlessMetrics/perl-lsp-swarm/actions/runs/28711942840) still contributes 7 `parse_recovery` entries |
...
| `.ci/perl-core-harness/upstream-comp-compile-baseline.json` | Ratchets 17/25 compile pass state; buckets: 8 `compile_effect` | Updated by focused #3485, #3487, #3490, #3492, #3494, #3498, #3500, and #3502 proofs for `comp/decl.t`, `comp/final_line_num.t`, `comp/parser.t`, `comp/require.t`, `comp/use.t`, `comp/proto.t`, and `comp/our.t`, plus focused #3530, #3532, #3534, #3536, #3538, #3540, and #3543 proofs for `comp/line_debug.t`, `comp/filter_exception.t`, `comp/redef.t`, `comp/multiline.t`, `comp/fold.t`, `comp/utf.t`, and `comp/parser_run.t`; separate from generated fixture baseline |
