...
| `target/perl-core/smoke/comp/compile.json` | 11/25 passed, 0 `parse_recovery`, 14 `compile_effect` | Focused runner proofs for #3485, #3487, #3490, #3492, #3494, #3498, #3500, and #3502 move `comp/decl.t` and `comp/our.t` to compile pass and `comp/require.t`, `comp/use.t`, `comp/proto.t`, `comp/final_line_num.t`, and `comp/parser.t` to `compile_effect`; focused runner proof for #3530 moves `comp/line_debug.t` to compile pass; compile-effect failures include `comp/filter_exception.t`, `comp/final_line_num.t`, `comp/fold.t`, `comp/form_scope.t`, `comp/hints.t`, `comp/multiline.t`, `comp/parser.t`, `comp/parser_run.t`, `comp/proto.t`, `comp/redef.t`, `comp/require.t`, `comp/retainedlines.t`, `comp/use.t`, `comp/utf.t` |
| `target/perl-core/smoke/comp/gap-map.json` | 29/50 mode-file entries passed; buckets: 7 `parse_recovery`, 14 `compile_effect` | Focused runner proofs for #3485, #3487, #3490, #3492, #3494, #3498, #3500, #3502, and #3530 update the accepted compile ratchet; parse-mode receipt from [run 28711942840](https://github.com/EffortlessMetrics/perl-lsp-swarm/actions/runs/28711942840) still contributes 7 `parse_recovery` entries |
...
| `.ci/perl-core-harness/upstream-comp-compile-baseline.json` | Ratchets 11/25 compile pass state; buckets: 14 `compile_effect` | Updated by focused #3485, #3487, #3490, #3492, #3494, #3498, #3500, and #3502 proofs for `comp/decl.t`, `comp/final_line_num.t`, `comp/parser.t`, `comp/require.t`, `comp/use.t`, `comp/proto.t`, and `comp/our.t`, plus focused #3530 proof for `comp/line_debug.t`; separate from generated fixture baseline |
