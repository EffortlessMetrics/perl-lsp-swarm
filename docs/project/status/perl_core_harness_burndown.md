...
| `target/perl-core/smoke/comp/compile.json` | 9/25 passed, 0 `parse_recovery`, 16 `compile_effect` | Focused runner proofs for #3485, #3487, #3490, #3492, #3494, #3498, and #3500 move `comp/decl.t` to compile pass and `comp/require.t`, `comp/use.t`, `comp/proto.t`, `comp/line_debug.t`, `comp/final_line_num.t`, and `comp/parser.t` to `compile_effect`; compile-effect failures include `comp/filter_exception.t`, `comp/final_line_num.t`, `comp/fold.t`, `comp/form_scope.t`, `comp/hints.t`, `comp/line_debug.t`, `comp/multiline.t`, `comp/our.t`, `comp/parser.t`, `comp/parser_run.t`, `comp/proto.t`, `comp/redef.t`, `comp/require.t`, `comp/retainedlines.t`, `comp/use.t`, `comp/utf.t` |
| `target/perl-core/smoke/comp/gap-map.json` | 27/50 mode-file entries passed; buckets: 7 `parse_recovery`, 16 `compile_effect` | Focused runner proofs for #3485, #3487, #3490, #3492, #3494, #3498, and #3500 update the accepted compile ratchet; parse-mode receipt from [run 28711942840](https://github.com/EffortlessMetrics/perl-lsp-swarm/actions/runs/28711942840) still contributes 7 `parse_recovery` entries |
...
| `.ci/perl-core-harness/upstream-comp-compile-baseline.json` | Ratchets 9/25 compile pass state; buckets: 16 `compile_effect` | Updated by focused #3485, #3487, #3490, #3492, #3494, #3498, and #3500 proofs for `comp/decl.t`, `comp/final_line_num.t`, `comp/line_debug.t`, `comp/parser.t`, `comp/require.t`, `comp/use.t`, and `comp/proto.t`; separate from generated fixture baseline |
