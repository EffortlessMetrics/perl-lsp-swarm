...
| `target/perl-core/smoke/comp/compile.json` | 9/25 passed, 2 `parse_recovery`, 14 `compile_effect` | Focused runner proofs for #3485, #3487, #3490, #3492, and #3494 move `comp/decl.t` to compile pass and `comp/require.t`, `comp/use.t`, `comp/proto.t`, and `comp/line_debug.t` to `compile_effect`; compile-effect failures include `comp/filter_exception.t`, `comp/fold.t`, `comp/form_scope.t`, `comp/hints.t`, `comp/line_debug.t`, `comp/multiline.t`, `comp/our.t`, `comp/parser_run.t`, `comp/proto.t`, `comp/redef.t`, `comp/require.t`, `comp/retainedlines.t`, `comp/use.t`, `comp/utf.t` |
| `target/perl-core/smoke/comp/gap-map.json` | 27/50 mode-file entries passed; buckets: 9 `parse_recovery`, 14 `compile_effect` | Focused runner proofs for #3485, #3487, #3490, #3492, and #3494 update the accepted compile ratchet; parse-mode receipt from [run 28711942840](https://github.com/EffortlessMetrics/perl-lsp-swarm/actions/runs/28711942840) still contributes 7 `parse_recovery` entries |
