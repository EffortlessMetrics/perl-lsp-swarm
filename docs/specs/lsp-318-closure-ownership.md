...
| relative-pattern-watcher | `RelativePattern` watcher registrations | accepted-disposition | n/a | protocol-identity correction owner #8897 | protocol types #11803 / PR #12096 | Watcher RelativePattern is an implemented LSP 3.17 surface. Capable clients receive watcher glob objects rooted at the workspace; unsupported clients retain string-glob fallback. |
