...
| `handle.by_id` | `DBIx::QuickORM::Handle` | `by_id` | handle | required | single_optional_row | zero_or_one | preserved_from_receiver | sync_with_async_row_result | permitted | runtime_resolved | `lib/DBIx/QuickORM/Handle.pm:1898` |
| `handle.by_ids` | `DBIx::QuickORM::Handle` | `by_ids` | handle | required | multiple_rows | arrayref_of_zero_or_more | preserved_from_receiver | sync_with_async_row_result | permitted | runtime_resolved | `lib/DBIx/QuickORM/Handle.pm:1938` |
