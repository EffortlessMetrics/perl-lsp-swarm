...
| #4923 | `clippy::ptr_arg` | 0 (force-warn measured) | Activated workspace-wide deny by #2313 after a zero-site pierced all-targets measurement; dead historical allows removed. |
