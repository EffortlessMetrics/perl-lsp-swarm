...
| Metric | Count |
|---|---|
| Total tracked files | 12274 |
| Rust-family files | 3749 |
| Non-Rust files | 8525 |
| Allowlisted | 6290 |
| Unclassified | 2235 |
...
| `crates/perl-corpus/fixtures/reachability_denominator/graph_shapes_test_caller.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-corpus/fixtures/reachability_denominator/lib/Collision.pm` | test | `non-rust-perl-modules` | parser/lsp-fixtures |
| `crates/perl-corpus/fixtures/reachability_denominator/lib/GraphShapes.pm` | test | `non-rust-perl-modules` | parser/lsp-fixtures |
| `crates/perl-corpus/fixtures/reachability_denominator/lib/Target.pm` | test | `non-rust-perl-modules` | parser/lsp-fixtures |
| `crates/perl-corpus/fixtures/reachability_denominator/local_flow_terminals.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-corpus/fixtures/reachability_denominator/scanner_falsifiers.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-corpus/fixtures/reachability_denominator/workspace_edges.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
...
| `fixtures/analysis_reachability_denominator/denominator-coverage-view.md` | documentation | `non-rust-root-governance-docs` | docs |
| `fixtures/analysis_reachability_denominator/manifest.json` | config | `non-rust-reachability-denominator-manifest` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/bounded_incomplete_collapse.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/collapsed_stage_field.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/duplicate_row_id.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/escaped_fixture_root.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/expected_errors.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/implementation_derived_oracle_positive.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/missing_exit_owner.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/profile_missing_work_dimensions.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/promoted_positive_without_opposite.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/push_race_without_client_expectation.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/terminal_empty_success.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/unowned_row.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/unsafe_partial_advertised.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
| `fixtures/analysis_reachability_denominator/self_fixtures/invalid/unstable_fixture_identity.json` | test | `non-rust-reachability-self-fixtures-invalid` | analysis/reachability |
...
| `schemas/analysis_reachability_fixture_manifest.v1.schema.json` | config | `non-rust-reachability-denominator-schema` | analysis/reachability |
