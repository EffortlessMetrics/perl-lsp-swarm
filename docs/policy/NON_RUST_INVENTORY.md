...
| `.changes/unreleased/product-12598-Changed-021722.yaml` | documentation | `non-rust-changelog-fragments` | release/ci |
...
| `.changes/unreleased/product-7082-Fixed-223000.yaml` | documentation | `non-rust-changelog-fragments` | release/ci |
...
| `.changes/unreleased/product-7887-Added-105700.yaml` | documentation | `non-rust-changelog-fragments` | release/ci |
...
| `.changes/unreleased/product-7922-Added-112200.yaml` | documentation | `non-rust-changelog-fragments` | release/ci |
...
| `.changes/unreleased/vscode-5291-Fixed-182701.yaml` | documentation | `non-rust-changelog-fragments` | release/ci |
...
| `.changes/unreleased/vscode-6869-Changed-000000.yaml` | documentation | `non-rust-changelog-fragments` | release/ci |
...
| `.changes/unreleased/vscode-7896-Changed-110300.yaml` | documentation | `non-rust-changelog-fragments` | release/ci |
| `.changes/unreleased/vscode-7904-Changed-110800.yaml` | documentation | `non-rust-changelog-fragments` | release/ci |
...
| `.ci/editor-clients/vim-vim-lsp-lifecycle-root.v1.json` | config | `non-rust-ci-config` | release/ci |
...
| `.github/workflows/pr-plan-head-name-guard.yml` | config | `non-rust-github-workflows` | release/ci |
...
| `.github/workflows/rolling-installed-public-beta-observation.yml` | config | `non-rust-github-workflows` | release/ci |
...
| `.spec/10301-formatter-property-fuzz-harness/acceptance.md` | documentation | `non-rust-root-governance-docs` | docs |
| `.spec/10301-formatter-property-fuzz-harness/checklist.md` | documentation | `non-rust-root-governance-docs` | docs |
| `.spec/10301-formatter-property-fuzz-harness/context.md` | documentation | `non-rust-root-governance-docs` | docs |
| `.spec/10302-formatter-production-pipeline-bench/acceptance.md` | documentation | `non-rust-root-governance-docs` | docs |
| `.spec/10302-formatter-production-pipeline-bench/checklist.md` | documentation | `non-rust-root-governance-docs` | docs |
| `.spec/10302-formatter-production-pipeline-bench/context.md` | documentation | `non-rust-root-governance-docs` | docs |
...
| `.spec/12823-corpus-cache-cycle/acceptance.md` | documentation | `non-rust-root-governance-docs` | docs |
| `.spec/12823-corpus-cache-cycle/checklist.md` | documentation | `non-rust-root-governance-docs` | docs |
| `.spec/12823-corpus-cache-cycle/context.md` | documentation | `non-rust-root-governance-docs` | docs |
...
| `.spec/1723/acceptance.md` | documentation | `non-rust-root-governance-docs` | docs |
| `.spec/1723/checklist.md` | documentation | `non-rust-root-governance-docs` | docs |
| `.spec/1723/context.md` | documentation | `non-rust-root-governance-docs` | docs |
...
| `clients/lite-xl/tests/server_initialize_capabilities_test.lua` | test | `non-rust-litexl-initialize-capabilities-tests` | editor/lite-xl |
...
| `clients/lite-xl/upstream/capability_manifest.lua` | production | `non-rust-litexl-capability-manifest` | editor/lite-xl |
...
| `clients/sublime/LSP-perllsp/Perl.sublime-project.example` | documentation | `non-rust-sublime-project-example` | editor/sublime |
| `clients/sublime/LSP-perllsp/README.md` | documentation | `non-rust-root-governance-docs` | docs |
| `clients/sublime/LSP-perllsp/command_surface.py` | production | `non-rust-command-surface` | editor/sublime |
| `clients/sublime/LSP-perllsp/compatibility.py` | production | `non-rust-sublime-compatibility` | editor/sublime |
| `clients/sublime/LSP-perllsp/compatibility.v1.json` | documentation | `non-rust-sublime-compatibility-registry` | editor/sublime |
| `clients/sublime/LSP-perllsp/dap_support.py` | production | `non-rust-sublime-dap-support` | editor/sublime |
| `clients/sublime/LSP-perllsp/debugger_adapter.py` | production | `non-rust-sublime-debugger-adapter` | editor/sublime |
...
| `clients/sublime/LSP-perllsp/host_tests/test_sublime_commands.py` | test | `non-rust-test-sublime-commands` | editor/sublime |
| `clients/sublime/LSP-perllsp/host_tests/test_sublime_debugger_adapter.py` | test | `non-rust-sublime-debugger-journey-test` | editor/sublime |
| `clients/sublime/LSP-perllsp/host_tests/test_sublime_host.py` | test | `non-rust-sublime-host-journey-test` | editor/sublime |
| `clients/sublime/LSP-perllsp/integration_commands.py` | production | `non-rust-sublime-integration-commands` | editor/sublime |
| `clients/sublime/LSP-perllsp/integration_status.py` | production | `non-rust-sublime-integration-status` | editor/sublime |
...
| `clients/sublime/LSP-perllsp/tests/test_dap_receipt.py` | test | `non-rust-sublime-dap-receipt-test` | editor/sublime |
| `clients/sublime/LSP-perllsp/tests/test_dap_support.py` | test | `non-rust-sublime-dap-support-test` | editor/sublime |
| `clients/sublime/LSP-perllsp/tests/test_host_contract.py` | test | `non-rust-sublime-host-contract-test` | editor/sublime |
| `clients/sublime/LSP-perllsp/tests/test_integration_status.py` | test | `non-rust-sublime-integration-status-test` | editor/sublime |
| `clients/sublime/LSP-perllsp/tests/test_package_source.py` | test | `non-rust-sublime-package-source-test` | editor/sublime |
...
| `clients/sublime/SOURCE_AUTHORITY.md` | documentation | `non-rust-root-governance-docs` | docs |
| `clients/sublime/dap-fixture/debug_current.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `clients/sublime/dap-unittesting.json` | test | `non-rust-sublime-dap-unittesting-config` | editor/sublime |
...
| `clients/sublime/package-source.v1.json` | documentation | `non-rust-sublime-package-source-registry` | editor/sublime |
| `clients/sublime/package_source.py` | production | `non-rust-sublime-package-source` | editor/sublime |
| `clients/sublime/sublime-command-receipt.v1.schema.json` | documentation | `non-rust-sublime-command-receipt-schema` | editor/sublime |
| `clients/sublime/sublime-host-receipt.v1.schema.json` | documentation | `non-rust-sublime-host-receipt-schema` | editor/sublime |
| `clients/sublime/validate_sublime_command_receipt.py` | test | `non-rust-sublime-command-receipt-validator` | editor/sublime |
| `clients/sublime/validate_sublime_dap_receipt.py` | test | `non-rust-sublime-dap-receipt-validator` | editor/sublime |
...
| `crates/perl-parser-pest/tests/fixtures/sources/bitwise-not/spaced-tilde.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/declaration-control-flow/foreach-my.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/declaration-control-flow/if-block.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/declaration-control-flow/simple-scalar.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/heredoc/bare-eof.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/heredoc/q-placeholder.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/nested-call/nested-multi.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/quoting-context/comment-double-dollar.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/quoting-context/qq-heredoc-token.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/quoting-context/regex-bitnot.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/recovery/strict-invalid.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/recovery/valid-invalid-valid.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/scalar-deref/double-dollar.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/statement-modifier/print-if.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/unicode-newline/bare-cr.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/unicode-newline/crlf.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/unicode-newline/identifier.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `crates/perl-parser-pest/tests/fixtures/sources/unicode-newline/lf.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
...
| `crates/perl-test-must/CLAUDE.md` | documentation | `non-rust-root-governance-docs` | docs |
...
| `docs/ci/gate-enforcement-app-bindings.md` | documentation | `non-rust-docs-tree` | docs |
...
| `docs/ci/github-enforcement-snapshot.md` | documentation | `non-rust-docs-tree` | docs |
...
| `docs/project/status/perl_builtin_semantics.md` | documentation | `non-rust-docs-tree` | docs |
...
| `docs/project/status/provider_fact_reads.md` | documentation | `non-rust-docs-tree` | docs |
...
| `fixtures/experience/standalone_candidate_selection/04_mixed_pair_rejected.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/05_published_unselected.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/06_failed_b_preserves_a.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/07_ab_selection_committed.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/08_rollback_b_to_a.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/09_malformed_current_record.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/10a_wrong_root_selection.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/10b_wrong_target_selection.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/11_cross_attempt_transition.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/12_independent_outcomes.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/13_source_mode_as_pair_rejected.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/14_dap_preview_cannot_weaken_pair.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/15_local_development_non_authoritative.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/16_candidate_identity_drift.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/17_generation_regression.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/18_revert_without_rollback.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
| `fixtures/experience/standalone_candidate_selection/19_rollback_target_not_governed.json` | test | `non-rust-standalone-candidate-selection-fixtures` | release/ci |
...
| `scripts/ci/check_rolling_installed_workflow.py` | tooling | `non-rust-ci-scripts-tree` | release/ci |
...
| `scripts/ci/evaluate_ci_gate.py` | tooling | `non-rust-ci-scripts-tree` | release/ci |
| `scripts/ci/fixtures/cargo_lock_conflict_policy.json` | tooling | `non-rust-ci-scripts-tree` | release/ci |
...
| `scripts/ci/rolling_installed_observation.py` | tooling | `non-rust-ci-scripts-tree` | release/ci |
...
| `scripts/ci/test_rust_small_route_contract.py` | tooling | `non-rust-ci-scripts-tree` | release/ci |
...
| `scripts/tests/test-public-api-label.sh` | tooling | `non-rust-ci-scripts-tree` | release/ci |
...
| `testdata/ux/first_ten_minutes/environment-sensitive-v1/local/lib/perl5/Local/SiteProbe.pm` | test | `non-rust-perl-modules` | parser/lsp-fixtures |
...
| `tree-sitter-perl/.clang-format` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/.editorconfig` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/.eslintrc.cjs` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/.gitattributes` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/.github/workflows/ci.yml` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/.github/workflows/release.yml` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/.gitignore` | config | `non-rust-gitignore-family` | release/ci |
| `tree-sitter-perl/.perltidyrc` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/CMakeLists.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/LICENSE` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/Makefile` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/PURE_RUST_PERFORMANCE_ANALYSIS.md` | documentation | `non-rust-root-governance-docs` | docs |
| `tree-sitter-perl/Package.swift` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/README.md` | documentation | `non-rust-root-governance-docs` | docs |
| `tree-sitter-perl/benchmark_pure_rust_comprehensive.sh` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/benchmark_test.pl` | test | `non-rust-perl-fixtures` | parser/lsp-fixtures |
| `tree-sitter-perl/binding.gyp` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/c/tree-sitter-perl.h` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/c/tree-sitter-perl.pc.in` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/go/binding.go` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/go/binding_test.go` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/go/go.mod` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/node/binding.cc` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/node/binding_test.js` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/node/index.d.ts` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/node/index.js` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/python/tests/test_binding.py` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/python/tree_sitter_perl/__init__.py` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/python/tree_sitter_perl/__init__.pyi` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/python/tree_sitter_perl/binding.c` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/python/tree_sitter_perl/py.typed` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/swift/TreeSitterPerl/perl.h` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/bindings/swift/TreeSitterPerlTests/TreeSitterPerlTests.swift` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/copy-to-release` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/cpanfile` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/go.mod` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/go.sum` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/grammar.js` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/lib/primitives.js` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/lib/unicode_ranges.js` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/package.json` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/pyproject.toml` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/queries/folds.scm` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/queries/highlights.scm` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/queries/injections.scm` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/queries/matchup.scm` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/run_true_benchmark.sh` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/setup.py` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/src/bsearch.h` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/src/scanner.c` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/src/tsp_unicode.h` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/benchmark.js` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/autoload-symbol-table.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/autoquote` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/edge-cases.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/exception-handling.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/expressions` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/file-io-system-advanced.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/file-operations.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/format-advanced.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/formats.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/functions` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/heredocs` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/heredocs-advanced.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/indirect-core-overrides.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/interpolation` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/literals` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/loader-forms.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/map-grep` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/modern-perl.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/module-import-patterns.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/object-oriented.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/operators` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/overload-mro.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/pack-unpack.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/perl-5-36-features.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/pod` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/prototypes-attributes-advanced.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/quote-like-operators.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/regex-code-verbs.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/regex-features-advanced.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/regexp` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/regexp-advanced.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/signal-handling.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/simple` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/source-filters-encoding.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/special-blocks-advanced.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/special-variables.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/statements` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/subroutines` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/symbolic-references.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/tie-interface.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/try-catch-defer.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/typeglob-slots.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/typeglobs.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/unicode.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/variables` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/test/corpus/xs-inline-c.txt` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
...
| `tree-sitter-perl/tree-sitter-perl.pc` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
| `tree-sitter-perl/tree-sitter.json` | generated | `non-rust-dir-tree-sitter-perl` | release/ci |
...
| `vscode-extension/scripts/check-typescript-authority-windows-shim.test.js` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/scripts/check-typescript-config-inventory.js` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/scripts/check-vsix-inventory-transition.js` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/scripts/typescript-config-inventory.json` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/scripts/vsix-inventory-transition.json` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/boundedFileDownload.ts` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/lspProviderCall.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/managedArchiveExtract.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/managedArchiveSafetyPolicy.ts` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/managedStartupPolicy.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/managedStorageIdentity.ts` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/releaseTopologyTargets.ts` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/test/boundedFileDownload.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/test/lspProviderCall.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/test/managedArchiveExtract.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/test/managedArchiveSafetyPolicy.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/test/managedReleaseSelector.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/test/managedStartupPolicy.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/test/managedStorageIdentity.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/test/serverDemand.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/test/serverDemandActivation.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/test/serverDemandDocuments.ts` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/test/typescriptConfigInventory.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/test/typescriptEmitContract.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
| `vscode-extension/src/test/typescriptPolicy.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/test/vsixPackageProjection.test.ts` | production | `non-rust-vscode-extension` | editor/vscode |
...
| `vscode-extension/src/vsixPackageProjection.ts` | production | `non-rust-vscode-extension` | editor/vscode |
