...
| Metric | Count |
|---|---|
| Total tracked files | 12448 |
| Rust-family files | 3839 |
| Non-Rust files | 8609 |
| Allowlisted | 6372 |
| Unclassified | 2237 |
...
| `crates/perl-lsp-perltidy/tests/formatter_property_harness_tests.proptest-regressions` | test | `non-rust-proptest-regressions` | parser/property-tests |
