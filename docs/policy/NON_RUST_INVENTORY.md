...
| `.ci/editor-clients/vim-vim-lsp-first-class-profile.v1.json` | config | `non-rust-ci-config` | release/ci |
...
| `scripts/ux/validate_vim_first_class_profile.py` | tooling | `non-rust-ci-scripts-tree` | release/ci |
