...
- [`crates/perl-lsp-rs/features_sot.toml`](../../crates/perl-lsp-rs/features_sot.toml) — since #7029, a deterministic generated byte projection of the root authority, regenerated with `cargo xtask features regen-vendored` and drift-checked by `features invariants`
