# LSP features — current-evidence pointer

This page is retained for compatibility with older book links. Its former release notes, feature checkmarks, result caps, timings, and v0.7.2 framing are not a current LSP support contract.
