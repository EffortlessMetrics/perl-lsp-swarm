# Known limitations — current-evidence pointer

This page is retained for compatibility with older book links. Its former parser comparison presented unsupported coverage percentages and production-readiness labels as current.
