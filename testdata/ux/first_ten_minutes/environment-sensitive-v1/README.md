...
`lib/Local/Probe.pm` and into the vendored
`local/lib/perl5/Local/SiteProbe.pm`, whether the `local/lib/perl5` entry
is treated as a bounded include path rather than a workspace wildcard, and
how `Config` introspection is presented.
