...
on the `eval`-guarded call. Correct behavior is a bounded, explained
limitation; manufactured exactness or unexplained silence are both
trust-breaking observations.
