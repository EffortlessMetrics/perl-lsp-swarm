...
<p align="center">
  ...
  <a href="https://marketplace.visualstudio.com/items?itemName=EffortlessMetrics.perl-lsp-rs"><img src="https://img.shields.io/badge/VS%20Marketplace-680%20installs-0078D4" alt="VS Marketplace installs" /></a>
...
<!-- Public Shields endpoint JSON under badges/ is generated by `python3 scripts/generate-badges.py`; verify with `python3 scripts/generate-badges.py --check`. -->
...
| First pull request | [docs/contributing/FIRST_PR.md](docs/contributing/FIRST_PR.md) |
| Agent workflow | [AGENTS.md](AGENTS.md) |
| Product and repository identity | [docs/reference/product-identity.md](docs/reference/product-identity.md) |
| Publication protocol | [docs/swarm/sync-protocol.md](docs/swarm/sync-protocol.md) |
| Historical and forensic records | [docs/forensics/](docs/forensics/) |
