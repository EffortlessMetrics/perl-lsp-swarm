...
class WorkflowSecurityRatchetTests(unittest.TestCase):
    ...
    def test_gh_aw_generated_lock_checkout_persist_is_accepted(self) -> None:
        # gh-aw emits persist-credentials: true on the safe_outputs push
        # checkout by specification; the lock file is regenerated and diffed
        # by the compile-check workflow, so the ratchet cannot require a
        # different shape.
        self.write(
            ".github/workflows/agent.lock.yml",
            "# This file was automatically generated by gh-aw (v0.88.7). DO NOT EDIT.\n"
            "name: agent\non: [workflow_dispatch]\npermissions: {}\njobs:\n  push:\n"
            "    permissions:\n      contents: write\n    runs-on: ubuntu-latest\n"
            "    steps:\n      - uses: actions/checkout@" + "a" * 40
    ...
    def test_unmarked_workflow_checkout_persist_is_still_flagged(self) -> None:
        # Without the generator marker the same shape must still fail closed.
        self.write(
    ...
    def test_empty_permissions_map_is_deny_all_not_indirection(self) -> None:
        self.write(
