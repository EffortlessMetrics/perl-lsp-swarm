...
//!
//! A successful parse is not a claim that semantic analysis, module resolution,
//! or runtime execution succeeded; use the relevant package for those layers.
//!
...
//! ```
//!
//! This example uses the public facade path a downstream crate receives.
//! More involved parser and editor workflows belong in the repository guides
//! and focused crate documentation.
//!
//! ## Public layers
//!
