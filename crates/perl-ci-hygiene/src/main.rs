...
#[cfg(test)]
use crate::commands::fatal_constructs::{is_allowlisted_exit_hit, normalize_path_for_match};
#[cfg(test)]
use crate::commands::ignored_tests::format_delta;
#[cfg(test)]
...
fn cmd_ignored_test_count(repo_root: &Path, update: bool, check: bool) -> Result<i32> {
    commands::ignored_tests::count_ignored_tests(repo_root, update, check)
}
