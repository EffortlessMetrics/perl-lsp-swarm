...
use crate::commands::benchmarks::{
    cmd_profile_stack_overflow, cmd_quick_bench, cmd_run_comparison, cmd_run_parser_comparison,
    cmd_simple_bench,
};
#[cfg(test)]
...
mod tests {
    use super::*;
    use crate::commands::benchmarks::{
        C_BENCH_BIN, C_BENCH_MANIFEST, FACADE_BENCH_BIN, FACADE_BENCH_CRATE, RUST_BENCH_BIN,
    };
