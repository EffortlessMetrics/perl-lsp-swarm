...
fn equiv_insert_at_end() {
    assert_equiv_after_edit(
        "my $x = 1;",
        Edit { start_byte: 10, old_end_byte: 10, new_end_byte: 3, new_text: "\n1;".to_string() },
    );
}
...
fn equiv_replace_middle() {
    assert_equiv_after_edit(
        "my $x = 1; my $y = 2;",
        Edit { start_byte: 11, old_end_byte: 12, new_end_byte: 2, new_text: "z".to_string() },
    );
}
...
fn equiv_delete_substring() {
    assert_equiv_after_edit(
        "my $foobar = 1;",
        Edit { start_byte: 6, old_end_byte: 9, new_end_byte: 0, new_text: String::new() },
    );
}
...
fn equiv_insert_in_string() {
    assert_equiv_after_edit(
        r#"my $s = "hello";"#,
        Edit { start_byte: 12, old_end_byte: 12, new_end_byte: 1, new_text: " world".to_string() },
    );
}
