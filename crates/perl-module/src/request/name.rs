...
impl ModuleName {
    ...
    pub fn parse_with_profile(
        ...
        let canonical = if has_legacy { text.replace('\'', "::") } else { text.to_string() };
        ...
        Ok(Self { canonical, separator_form })
    }
...
#[cfg(test)]
mod tests {
    use super::{LegacySeparatorProfile, ModuleName, ModuleNameError, PackageSeparatorForm};
