...
#[test]
fn recovered_reports_its_stored_location() {
...
#[test]
fn recovered_missing_operand_reports_its_stored_location() {
    let error = ParseError::Recovered {
...
#[test]
fn unexpected_eof_stays_anchored_at_end_of_input() {
    assert_eq!(
...
#[test]
fn nesting_too_deep_stays_anchored_at_start_of_file() {
...
#[test]
fn out_of_range_location_is_clamped_to_the_source_length() {
