...
impl PerlOracleEnv {
    ...
    /// - `timeout`: `SYSTEM_INC_PROBE_TIMEOUT` (1 second) in every build
    ///   except this crate's own unit tests, which may widen it per thread
    ///   via `SystemIncProbeTimeoutGuard` (#12902).
