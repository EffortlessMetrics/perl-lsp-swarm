...
impl PerlOracleEnv {
    ...
    /// - `timeout`: `SYSTEM_INC_PROBE_TIMEOUT` (1 second). Test builds may
    ///   widen it for the calling thread only; see
    ...
    /// - `timeout`: `SYSTEM_INC_PROBE_TIMEOUT`, via the same helper as the
    ///   startup probe.
