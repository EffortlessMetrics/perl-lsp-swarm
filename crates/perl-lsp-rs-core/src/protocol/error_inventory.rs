...
pub fn error_type_inventory() -> Vec<ErrorInventoryEntry> {
    vec![
        ...
        ErrorInventoryEntry {
            ...
            crate_name: "perl-lsp-rs-core",
            has_error_class: false, // Wire-only; Perl adapter owns classification (#7599/#7611)
...
mod tests {
    ...
    fn unclassified_types_are_wire_or_origin_ambiguous() {
        ...
        assert_eq!(
            ...
            "JsonRpcError is intentionally wire-only (#7599/#7611); stack/variable parse enums stay unclassified without origin"
        );
    }
