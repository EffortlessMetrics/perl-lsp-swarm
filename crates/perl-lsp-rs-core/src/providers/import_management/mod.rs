...
//!
//! The hard-coded function-to-module affinity table is withdrawn (#10690): a
//! bare spelling never grants import-edit authority. Exact unresolved-subject
//! selection and insertion planning belong to #790/#8948.
