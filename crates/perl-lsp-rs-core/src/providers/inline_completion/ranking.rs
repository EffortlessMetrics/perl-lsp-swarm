...
impl InlineCandidateConfidence {
    pub(super) fn for_reason(reason: InlineCandidateReason) -> Self {
        match reason {
...
pub(super) fn module_candidate_bonus(
    item: &InlineCompletionItem,
    context: &SemanticInlineContext,
) -> i16 {
...
pub(super) fn receiver_candidate_bonus(
    item: &InlineCompletionItem,
    context: &SemanticInlineContext,
) -> i16 {
...
pub(super) fn syntax_candidate_bonus(
    item: &InlineCompletionItem,
    context: &SemanticInlineContext,
) -> i16 {
    match context.expected_syntax {
...
pub(super) fn test_candidate_bonus(context: &SemanticInlineContext) -> i16 {
    match context.expected_syntax {
...
pub(super) fn shebang_candidate_bonus(context: &SemanticInlineContext) -> i16 {
    if context.expected_syntax == ExpectedSyntax::ShebangInterpreter { 20 } else { 0 }
}

pub(super) fn contextual_fallback_candidate_bonus(
    item: &InlineCompletionItem,
    context: &SemanticInlineContext,
) -> i16 {
