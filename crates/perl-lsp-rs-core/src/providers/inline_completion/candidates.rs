...
use super::{
    ExpectedSyntax, FileRole, InlineCompletionItem, InlineCompletionProvider,
    PreparedInlineCompletionContext, ReceiverHint, SemanticInlineContext, VariableFact,
};
...
pub(super) trait InlineCandidateSource {
...
pub(super) struct ReceiverCandidateSource;

#[derive(Debug, Clone, Copy)]
pub(super) struct ModuleCandidateSource;

#[derive(Debug, Clone, Copy)]
pub(super) struct SyntaxCandidateSource;

#[derive(Debug, Clone, Copy)]
pub(super) struct TestCandidateSource;

#[derive(Debug, Clone, Copy)]
pub(super) struct ShebangCandidateSource;

#[derive(Debug, Clone, Copy)]
pub(super) struct ContextualFallbackSource;

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) enum HardRejectZone {
    Comment,
    StringLike,
    HeredocBody,
    Pod,
