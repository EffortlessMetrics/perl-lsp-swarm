...
// The name-affinity import quick fix is withdrawn (#10690): resolving a
// bareword against the hard-coded function-to-module map granted no
// import-edit authority. Restoration belongs to the #790/#8948 exact planner
// trains, never to a revert. The surviving PL109 family (`fix_bareword`:
// quoting and filehandle declaration) is intact.
