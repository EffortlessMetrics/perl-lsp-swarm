...
/// Workspace policy channels: project and client inputs that may write
/// workspace policy. `Environment` and `SystemProbe` observations are
/// downstream derived facts about the world, never writers of the policy
/// fields that name them, so they are absent here by law (#10790).
const WORKSPACE_POLICY: &[Source] = &[
    Source::CompiledDefault,
    Source::InitializationOptions,
    Source::ProjectFile,
    Source::GlobalClientSettings,
