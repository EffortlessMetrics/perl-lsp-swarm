...
impl CriticRule for DuplicateParameterRule {
    ...
    fn default_severity(&self) -> Severity {
        // Duplicate parameters are a style/correctness issue, not a critical
        // error. Stern maps to LSP WARNING so editors show yellow squiggles
        // instead of red ERROR markers.
        Severity::Stern
    }
...
impl CriticRule for DuplicateLexicalDeclarationRule {
    ...
    fn default_severity(&self) -> Severity {
        // Duplicate lexical declarations are a style/correctness issue, not a
        // critical error. Stern maps to LSP WARNING so editors show yellow
        // squiggles instead of red ERROR markers.
        Severity::Stern
    }
