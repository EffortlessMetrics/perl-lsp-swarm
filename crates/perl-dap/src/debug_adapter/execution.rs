...
impl DebugAdapter {
    ...
    pub(super) fn handle_continue(
        ...
        let mut thread_id = 1;
        let has_active = if let Some(ref mut session) =
        ...
        if !has_active {
            return DapMessage::Response {
                ...
                body: None,
                message: Some(no_active_debug_session_message("continue")),
            };
        }

        // AC9.4: Proper DAP event emission: continued (only when session is active)
        self.send_event(
            "continued",
            Some(json!({
                "threadId": thread_id,
    ...
    pub(super) fn handle_next(
        ...
        if !has_session {
            return DapMessage::Response {
                ...
                body: None,
                message: Some(no_active_debug_session_message("next")),
            };
        }
    ...
    pub(super) fn handle_step_in(
        ...
        if !has_session {
            return DapMessage::Response {
                ...
                body: None,
                message: Some(no_active_debug_session_message("stepIn")),
            };
        }
    ...
    pub(super) fn handle_step_out(
        ...
        if !has_session {
            return DapMessage::Response {
                ...
                body: None,
                message: Some(no_active_debug_session_message("stepOut")),
            };
        }
