...
mod tests {
    ...
    fn oracle_for_maps_known_assertions_only() {
        assert_eq!(oracle_for("is"), Some(("exact_return_assertion", "strong_exact")));
        assert_eq!(oracle_for("ok"), Some(("smoke_ok", "weak_smoke")));
        assert_eq!(oracle_for("throws_ok"), Some(("exception_observer", "weak_broad")));
