...
pub use model::{
    ...
    CompilePhaseBlock, CompileProvenance, ControlTransfer, ControlTransferKind, DerefAggregateKind,
    ...
    FrameworkFactGraph, GlobSlot, GlobSlotKind, GlobSlotSource, HIR_BODY_MODEL_VERSION,
    ...
    PrototypeFact, PrototypeTable, RecoveryConfidence, RegexExpr, RequireDecl, ScopeFrame,
    ...
    SubDecl, SubstitutionExpr, TransliterationExpr, UseDecl, VariableBinding, VariableDecl,
};
