...
pub use body::{
    ...
    HirSubstitution, HirTransliteration, HirVariable, LoopControlVerb, RegexAnalysisAnchor,
    ReplacementEvaluation, Sigil, SubscriptKind, UnaryMode, VariableKind, lower_body,
};
