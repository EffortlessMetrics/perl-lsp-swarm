...
pub use model::{
    ...
    ModuleResolutionCandidateStatus, ModuleResolutionRoot, ModuleResolutionStatus,
    PROTOTYPE_TABLE_MODEL_VERSION, PackageDecl, PackageInheritanceEdge, PackageStash,
