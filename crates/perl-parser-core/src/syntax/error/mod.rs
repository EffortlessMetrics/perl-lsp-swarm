...
//!
//! Parser failures are represented by the public error types in this module.
//! The parser facade may recover and retain partial information, but callers
//! must not treat recovery as semantic or runtime validation.
//!
