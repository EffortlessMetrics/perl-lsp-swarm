...
/// Validate match-family modifier letters: `m s i x p o d u a l n g c`,
/// plus the doubled `xx` and `aa` forms. The `e` and `r` modifiers belong
/// to `s///` only and are explicitly rejected (#14980).
///
