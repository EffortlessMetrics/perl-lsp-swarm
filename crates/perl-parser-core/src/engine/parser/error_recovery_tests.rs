...
/// CR-only source is a valid Perl line ending and must take the same recovery
/// boundary as LF source. The old scan trimmed `\r` before checking for `\n`,
/// so this named subroutine was swallowed into the unclosed qw list.
#[test]
