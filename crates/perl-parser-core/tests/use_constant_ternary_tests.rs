...
fn test_use_constant_ternary_with_number_lhs() {
    ...
    assert_use_args(
        ...
        "(use (module constant) (args FOO 1 ? 'a' : 'b'))",
    );
}
...
fn test_use_constant_ternary_with_string_lhs() {
    ...
    assert_use_args(
        ...
        "(use (module constant) (args FOO 'yes' ? 1 : 0))",
    );
}
...
fn test_use_constant_number_with_binary_op() {
    ...
    assert_use_args("use constant BAR => 1 + 2;", "(use (module constant) (args BAR 1 + 2))");
}
...
fn test_use_constant_string_with_concat_op() {
    ...
    assert_use_args(
        ...
        "(use (module constant) (args BAZ 'hello' . \"' world'\"))",
    );
}
...
fn test_use_constant_number_comparison() {
    ...
    assert_use_args(
        ...
        "(use (module constant) (args OLD 5.008 < 5.016))",
    );
}
...
fn test_use_constant_ternary_nested() {
    ...
    assert_use_args(
        ...
        "(use (module constant) (args X 1 ? 2 ? 'a' : 'b' : 'c'))",
    );
}
...
fn test_use_constant_ternary_with_nested_fat_arrows() {
    assert_use_args(
        ...
        "(use (module constant) (args MAP 1 ? { foo => 'a' } : { bar => 'b' }))",
    );
}
