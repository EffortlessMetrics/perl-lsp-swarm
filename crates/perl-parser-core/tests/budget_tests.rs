...
fn tracker_errors_exhausted() -> Result<(), Box<dyn std::error::Error>> {
    let budget = { let mut b = ParseBudget::default(); b.max_errors = 2; b };
    let mut tracker = BudgetTracker::new();
...
fn tracker_depth_would_exceed() -> Result<(), Box<dyn std::error::Error>> {
    let budget = { let mut b = ParseBudget::default(); b.max_depth = 2; b };
    let mut tracker = BudgetTracker::new();
...
fn tracker_skip_would_exceed() -> Result<(), Box<dyn std::error::Error>> {
    let budget = { let mut b = ParseBudget::default(); b.max_tokens_skipped = 10; b };
    let tracker = BudgetTracker::new();
...
fn tracker_begin_recovery_checks_budget() -> Result<(), Box<dyn std::error::Error>> {
    let budget = { let mut b = ParseBudget::default(); b.max_recoveries = 1; b };
    let mut tracker = BudgetTracker::new();
...
fn tracker_can_skip_more() -> Result<(), Box<dyn std::error::Error>> {
    let budget = { let mut b = ParseBudget::default(); b.max_tokens_skipped = 5; b };
    let tracker = BudgetTracker::new();
