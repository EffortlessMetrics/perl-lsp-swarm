...
pub(crate) fn validate_capture_identity(nonce: &str) -> Result<(), String> {
...
pub(crate) fn validate_argument(argument: &str) -> Result<(), String> {
...
pub(crate) fn validate_artifact_path(path: &str) -> Result<(), String> {
