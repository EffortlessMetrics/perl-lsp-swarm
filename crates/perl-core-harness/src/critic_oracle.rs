...
impl OracleSubject {
    ...
    pub fn new(
        identities: OracleSubjectIdentities,
        invocation: OracleInvocation,
    ) -> Result<Self, OracleSubjectError> {
        let subject = Self {
            perl_identity: identities.perl_identity,
            critic_identity: identities.critic_identity,
            fixture_digest: identities.fixture_digest,
            root_identity: identities.root_identity,
            source_digest: identities.source_digest,
            profile_digest: identities.profile_digest,
            invocation,
            environment_digest: identities.environment_digest,
            process_schema: identities.process_schema,
            parser_schema: identities.parser_schema,
        };
        subject.validate()?;
        Ok(subject)
    }
...
#[derive(Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize)]
pub struct OracleSubjectIdentities {
...
mod tests {
    ...
    fn subject(root: &str, profile: &str) -> OracleSubject {
        OracleSubject::new(
            OracleSubjectIdentities {
                perl_identity: "perl-5.40.2-build-a".into(),
                critic_identity: "perlcritic-1.152".into(),
                fixture_digest: "sha256:fixture".into(),
                ...
                process_schema: "process-plan.v1".into(),
                parser_schema: "perlcritic-parser.v2".into(),
            },
            OracleInvocation {
                severity: 3,
    ...
    fn each_non_invocation_identity_axis_changes_the_subject() {
        ...
        let variants = [
            OracleSubject::new(
                OracleSubjectIdentities {
                    perl_identity: "perl-5.40.2-build-b".into(),
                    critic_identity: "perlcritic-1.152".into(),
                    fixture_digest: "sha256:fixture".into(),
                    root_identity: "root".into(),
                    source_digest: "sha256:source".into(),
            ...
            OracleSubject::new(
                OracleSubjectIdentities {
                    perl_identity: "perl-5.40.2-build-a".into(),
                    critic_identity: "perlcritic-1.153".into(),
                    fixture_digest: "sha256:fixture".into(),
                    root_identity: "root".into(),
                    source_digest: "sha256:source".into(),
                    profile_digest: "sha256:profile".into(),
            ...
            OracleSubject::new(
                OracleSubjectIdentities {
                    perl_identity: "perl-5.40.2-build-a".into(),
                    critic_identity: "perlcritic-1.152".into(),
                    fixture_digest: "sha256:fixture-b".into(),
                    root_identity: "root".into(),
                    source_digest: "sha256:source".into(),
                    profile_digest: "sha256:profile".into(),
                    environment_digest: "sha256:environment".into(),
            ...
            OracleSubject::new(
                OracleSubjectIdentities {
                    ...
                    fixture_digest: "sha256:fixture".into(),
                    root_identity: "root".into(),
                    source_digest: "sha256:source-b".into(),
                    profile_digest: "sha256:profile".into(),
                    environment_digest: "sha256:environment".into(),
                    process_schema: "process-plan.v1".into(),
                    parser_schema: "perlcritic-parser.v2".into(),
            ...
            OracleSubject::new(
                OracleSubjectIdentities {
                    ...
                    source_digest: "sha256:source".into(),
                    profile_digest: "sha256:profile".into(),
                    environment_digest: "sha256:environment-b".into(),
                    process_schema: "process-plan.v1".into(),
                    parser_schema: "perlcritic-parser.v2".into(),
                },
                baseline.invocation.clone(),
            ...
            OracleSubject::new(
                OracleSubjectIdentities {
                    ...
                    profile_digest: "sha256:profile".into(),
                    environment_digest: "sha256:environment".into(),
                    process_schema: "process-plan.v2".into(),
                    parser_schema: "perlcritic-parser.v2".into(),
                },
                baseline.invocation.clone(),
            )
            ...
            OracleSubject::new(
                OracleSubjectIdentities {
                    ...
                    environment_digest: "sha256:environment".into(),
                    process_schema: "process-plan.v1".into(),
                    parser_schema: "perlcritic-parser.v3".into(),
                },
                baseline.invocation.clone(),
            )
    ...
    fn tool_and_environment_movement_changes_the_subject() {
        let first = OracleSubject::new(
            OracleSubjectIdentities {
                ...
                source_digest: "sha256:source".into(),
                profile_digest: "sha256:profile".into(),
                environment_digest: "sha256:environment-a".into(),
                process_schema: "process-plan.v1".into(),
                parser_schema: "perlcritic-parser.v2".into(),
            },
            OracleInvocation {
    ...
    fn private_paths_are_not_receipt_identities() {
        let error = OracleSubject::new(
            OracleSubjectIdentities {
                perl_identity: "perl".into(),
                critic_identity: "critic".into(),
                fixture_digest: "fixture".into(),
                root_identity: "/private/fixture".into(),
                source_digest: "source".into(),
                profile_digest: "profile".into(),
                environment_digest: "environment".into(),
                process_schema: "process".into(),
                parser_schema: "parser".into(),
            },
            OracleInvocation {
                severity: 3,
                theme: None,
