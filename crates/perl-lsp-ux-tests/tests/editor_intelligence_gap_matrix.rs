...
completion.returned_hash_shape.same_file|gap|completion|workspace|wired|bounded_fallback|unit|low|current|true|7440|completion_returned_hash_shape_same_file|returned_shape_not_propagated|near_miss_control_required|returned_hash/cases.pl
completion.returned_hash_shape.cross_module|gap|completion|workspace|wired|gap|multi_file|unknown|current|true|7440|completion_returned_hash_shape_cross_module|cross_module_shape_unavailable|near_miss_control_required|returned_hash/cases.pl
...
type_flow.ref_hash_narrowing|gap|type_flow|workspace|not_applicable|gap|unit|unknown|current|true|7437|type_flow_ref_hash_narrowing|ref_narrowing_missing|near_miss_control_required|flow/narrowing.pl
type_flow.isa_narrowing|gap|type_flow|workspace|not_applicable|gap|unit|unknown|current|true|7437|type_flow_isa_narrowing|isa_narrowing_missing|near_miss_control_required|flow/narrowing.pl
type_flow.defined_narrowing|gap|type_flow|workspace|not_applicable|gap|unit|unknown|current|true|7437|type_flow_defined_narrowing|defined_narrowing_missing|near_miss_control_required|flow/narrowing.pl
...
dispatch.literal_method_selector|gap|dispatch|workspace|wired|gap|unit|unknown|current|true|7446|dispatch_literal_method_selector|selector_fact_missing|near_miss_control_required|dispatch/cases.pl
dispatch.constant_method_selector|gap|dispatch|workspace|wired|gap|unit|unknown|current|true|7446|dispatch_constant_method_selector|constant_selector_missing|near_miss_control_required|dispatch/cases.pl
dispatch.finite_loop_selector|gap|dispatch|workspace|wired|gap|unit|unknown|current|true|7446|dispatch_finite_loop_selector|finite_selector_missing|near_miss_control_required|dispatch/cases.pl
...
framework.user_loaded_adapter|gap|framework|generated|absent|gap|none|unknown|not_proven|false|7459|framework_user_loaded_adapter|user_adapter_runtime_missing|near_miss_control_required|none
