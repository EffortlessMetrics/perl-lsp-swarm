...
separate subagent merely because the route moved from implementation to verification. A
bounded subagent or context fork is useful only when another environment or high-output
instrument materially changes the evidence.
