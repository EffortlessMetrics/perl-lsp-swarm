---
name: deliver-pr
description: Run one coherent claim through its named Claude route in one persistent claim-local lane, preserving context across review, repair, proof, live integration, and closeout.
...
disposition when the information changes claim, authority, plan, proof obligation,
route, prerequisite, support, risk, rollback, or closeout meaning; prevents useful
evidence from being rediscovered; or records a real external wait/wake event.

Keep agent identity, topology, liveness, retries, provisional reasoning, raw logs,
...
One persistent claim-local context follows the route through issue, proof, candidate,
review, integration, merge, and closeout without paying a new subagent cold start at
each skill boundary.
