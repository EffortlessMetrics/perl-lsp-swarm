...
- **RED** — non-mechanical, non-INFRA-NOISE failures (includes DEVELOPER-CANCEL: `concluded: cancelled` with >5s duration). Set `needs-ci-fix` and bounce to pr-responder with details.
