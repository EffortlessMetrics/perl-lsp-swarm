...
| CRW-007 | `corpus-ratchet-full` only enforces when `needs.corpus-warm-full.outputs.complete == 'true'`; during convergence it skips neutrally instead of false-reding from platform kills | `ratchet_job_gates_on_warm_completion_output` | offline |
