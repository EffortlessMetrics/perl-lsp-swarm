...
| An effect emitted without an inventory row is structurally forced to register | Any new production mutation site changes a ledger count (or adds an unregistered needle) and fails the ratchet; every mutating row must own ≥1 registered site |
