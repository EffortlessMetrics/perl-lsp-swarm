...
| FMT-FINAL-008 | Stale/invalid/conflicting/unrepresentable plans are non-applied | `reversed_ranges_are_rejected_not_clamped`; `unreachable_positions_are_rejected_not_clamped`; `mid_code_point_positions_are_rejected_in_both_encodings`; `adjacent_edits_are_allowed_but_overlap_is_rejected`; `duplicate_zero_width_insertion_points_are_rejected` | offline |
